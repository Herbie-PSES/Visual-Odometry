...
node_class::node_class():relativePoses(10)
{
    ...
    float camera_parameters[] = {540.68603515625, 0.0, 479.75, 0.0, 540.68603515625, 269.75, 0.0, 0.0, 1.0};
...
void node_class::loop_function()
{
    ...
    isfound = rgbdOdometry.compute(img_last, depth_current, mask, img_current, depth_last, mask, Rt); // Standard init is last Rt
...
void node_class::imageCallback(const sensor_msgs::Image::ConstPtr& imagMsg)
{
    ...
    cv_ptr_image = cv_bridge::toCvCopy(imagMsg, imagMsg->encoding); // 8-Bit Greyscale Image
...
void node_class::run_once()
{
    ...
    depth_image_sub = i_trans.subscribe("/kinect2/qhd/image_depth_rect",1,&node_class::depth_imageCallback,this);
